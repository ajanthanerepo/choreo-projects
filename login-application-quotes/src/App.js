...
function App() {
  ...
  useEffect(() => {
    const fetchPost = async () => {
       const response = await fetch('https://b8427943-6ba9-4aaf-b410-9ee8377dcb41-dev-internal.e1-eu-north-azure.internal.choreoapis.dev/rentcarquoteservice/quotes/v1.0/allCarQuotes');
